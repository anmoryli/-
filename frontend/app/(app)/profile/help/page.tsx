...
const faqItems = [
  ...
  },
  {
    question: "记录助手能做什么？",
    answer:
      "记录助手专注陪伴您的孕期记录：帮您整理记录、生成本周小结和孕周回顾，辅助写信给宝宝、润色文字，在您不知道写什么时提供记录灵感建议。孕妇本人与配偶均可使用。对话中提及配偶（如老公、老婆）时，系统会尝试向配偶邮箱发送通知，并在回复末尾追加「已发送给配偶了」；若家中未添加配偶或配偶未绑定邮箱，会提示先到「家人共享」设置。涉及医疗问题时会提醒您咨询医生。",
  },
  {
    question: "对话里提到老公/老婆，为什么没有发邮件也没有追加消息？",
    answer:
      "请确认：1）您已在「家人共享」中创建或加入家庭，并已将一位成员的关系设为配偶（老公/老婆/丈夫/妻子等）；2）该配偶账号已绑定邮箱（在「我的」或设置中可绑定）。满足后，在记录助手中发送包含配偶关键词的消息，回复结束后会发送邮件并在对话中追加「已发送给配偶了」。若仍无反应，请查看后端日志中的「配偶提及」相关输出。",
  },
  {
    question: "爸爸成长营与站内消息怎么用？",
    answer:
      "「爸爸成长营」在「我的」中进入，可查看分配给您的家庭任务（如陪同产检、情感任务）。孕妇在「家人共享」页面点击「生成本周任务（推送给配偶）」即可为配偶生成本周任务，配偶会在「站内消息」中收到任务通知。在「我的」→「站内消息」可查看所有通知并标记已读。",
  },
  {
  ...
  },
  {
    question: "忘记密码怎么办？",
    answer:
      "若已绑定邮箱，可在登录页通过「找回密码」重置。登录后可在「我的」→「修改密码」中随时修改密码，请牢记您的新密码。",
  },
  {
    question: "如何注销账号？",
    answer:
  ...
  },
  {
    question: "家人共享怎么用？",
    answer:
      "进入「我的」→「家人共享」。创建者点击「创建家庭」获取 6 位邀请码，复制后发给家人。家人在「家人共享」页面点「通过邀请码加入其他家庭」，输入邀请码并选择与孕妇的关系（如配偶、爸爸、妈妈或自定义）即可加入。一名孕妇只能设置一名配偶；配偶可使用记录助手并接收提及邮件。邀请码有效期 7 天。",
  },
]
