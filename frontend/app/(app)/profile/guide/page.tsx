...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      "孕妇可在「家人共享」中为配偶生成本周任务（如陪同产检、情感任务）",
  ...
  },
  {
    ...
    items: [
      ...
      "绑定邮箱（用于找回密码、配偶提及通知及爸爸成长营任务邮件提醒）",
      "爸爸成长营（仅孕妇/配偶）、站内消息、我的模板作品、家人共享",
